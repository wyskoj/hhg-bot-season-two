...
public class Quest18 extends ListenerAdapter implements Serializable {
	 ...
	 */
	final String QUEST_NAME = "quest-17";
	...
	transient ArrayList<ValidCode> validCodes = new ArrayList<ValidCode>() {{
		add(new ValidCode("3rvf5d", 2));
		add(new ValidCode("lbsd4e", 2));
		add(new ValidCode("ufvzcs", 2));
		add(new ValidCode("vppzak", 2));
	}};
	 ...
	 * </ul>
	 */
	final CodeUse CODE_USE = CodeUse.ONCE_PER_TEAM;
	...
	public static void main(String[] args) throws LoginException {
		...
		builder.addEventListener(new Quest18());
		/* Defined on start */
